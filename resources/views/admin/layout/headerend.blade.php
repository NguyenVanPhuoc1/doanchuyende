...
<head>
    ...
    <link rel="icon" href="{{ asset('front/image/logo-3016.png')}}" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('front/image/logo-3016.png')}}" type="image/x-icon">
    ...
    <!-- Brand Logo -->
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 text-center">
                <div class="image">
                    <img class="lazy loaded"  data-src="{{ asset('admin/image/logo_web.png')}}" alt="Nhóm B"
                    src="{{ asset('admin/image/logo_web.png')}}" data-was-processed="true" style="width: 80px; height: 80px;">
                </div>
            </div>
