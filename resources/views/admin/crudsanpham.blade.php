                                        ...
                                        <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                            <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control for-seo text-sm" name="product_name" id="product_name" placeholder="Tên Sản Phẩm" value="" required>
                                                </div>
                                                <div class="form-group">
                                    ...
                                    <div class="card-body card-article">
                                        <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                            <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang">
                                                <div class="form-group">
                                                    <label for="product_name">Tên Sản Phẩm (vi):</label>
                                                    <input type="text" class="form-control for-seo text-sm" name="product_name" id="product_name" placeholder="Tên Sản Phẩm" value="{{$product->name}}" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="product_desc">Nội dung (vi):</label>
